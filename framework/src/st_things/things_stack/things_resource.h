...
typedef struct things_representation_s {
	 ...
	 * @param rep : Instance of representation
	...
	//-----------------------------------------------------------------------------
        /**
         * @brief API for setting bool type value with a key
         * @param rep : Instance of representation
         * @param key : Attribute Key which will represent the value
	...
	//-----------------------------------------------------------------------------
        /**
         * @brief API for setting integer type value with a key
         * @param rep : Instance of representation
         * @param key : Attribute Key which will represent the value
         * @param int64_t : Integer value
         */
	void (*things_set_int_value)(struct things_representation_s *rep, char *key, int64_t);

	//-----------------------------------------------------------------------------
        /**
         * @brief API for setting double type value with a key
         * @param rep : Instance of representation
         * @param key : Attribute Key which will represent the value
	...
	//-----------------------------------------------------------------------------
        /**
         * @brief API for setting byte type value with a key
         * @param rep : Instance of representation
         * @param key : Attribute Key which will represent the value
         * @param value : Byte value
	 * @param size  : Size of Byte value
         */
	void (*things_set_byte_value)(struct things_representation_s *rep, char *key, uint8_t *value, size_t size);

	//-----------------------------------------------------------------------------
        /**
         * @brief API for setting object type value with a key
         * @param mother : Instance of representation
         * @param key : Attribute Key which will represent the value
         * @param child : Object value
	 * @return : true if setting value is successful, otherwise false
         */
	bool(*things_set_object_value)(struct things_representation_s *mother, char *key, struct things_representation_s *child);

	//-----------------------------------------------------------------------------
	/**
	 * @brief API for setting object array type of attribute.
	 * @param things_representation_s * : Instance of representation
	 ...
	 * @return : true if setting object array value is successful, otherwise false
	 */
	bool(*things_set_arrayvalue)(struct things_representation_s *, char *key, int length, struct things_representation_s **reps);

	//-----------------------------------------------------------------------------
        /**
         * @brief API for getting object array type of attribute.
         * @param things_representation_s * : Instance of representation
         * @param key : Attribute Key which will represent the array type of value
         * @param length : Length of value(representation) array
         * @param reps : Array type (representation) values
	 * @return : true if getting object array value is successful, otherwise false
         */
	bool(*things_get_arrayvalue)(struct things_representation_s *, char *key, int *length, struct things_representation_s ***reps);

	//-----------------------------------------------------------------------------
	/**
	 * @brief API for setting string array type of attribute.
	 * @param mother : Instance of representation
	 * @param key : Attribute Key which will represent the array type of value
	...
	//-----------------------------------------------------------------------------
        /**
         * @brief API for getting string array type of attribute.
	 * @param mother : Instance of representation
         * @param key : Attribute Key which will represent the array type of value
         * @param length : Length of value(string) array
         * @param array : Array type string values
	 * @return : true if getting string array value is successful, otherwise false
         */
	bool(*things_get_string_arrayvalue)(struct things_representation_s *mother, char *key, int *length, char ***array);

	//-----------------------------------------------------------------------------
	/**
	 * @brief API for setting double array type of attribute.
	 * @param mother : Instance of representation
	 * @param key : Attribute Key which will represent the array type of value
	...
	//-----------------------------------------------------------------------------
        /**
         * @brief API for getting double array type of attribute.
         * @param mother : Instance of representation
         * @param key : Attribute Key which will represent the array type of value
         * @param length : Length of value(double) array
         * @param array : Array type double values
	...
	*/
	...
	//-----------------------------------------------------------------------------
        /**
        * @brief API for getting int array type of attribute.
	* @param mother : Instance of representation
        * @param key : Attribute Key which will represent the array type of value
        * @param length : Length of value(int) array
        * @param array : Array type int values
	* @return : true if getting int array value is successful, otherwise false
        */
	...
	//-----------------------------------------------------------------------------
        /**
         * @brief API for getting bool type value with a key
         * @param rep   : Instance of representation
         * @param key   : Attribute Key which represents the value
         * @param bool * : bool value
         * @return      : true(value exist), false(value not exist)
	...
	//-----------------------------------------------------------------------------
        /**
         * @brief API for getting int type value with a key
         * @param rep   : Instance of representation
         * @param key   : Attribute Key which represents the value
         * @param int64_t : integer value
         * @return      : true(value exist), false(value not exist)
	...
	//-----------------------------------------------------------------------------
        /**
         * @brief API for getting double type value with a key
         * @param rep   : Instance of representation
         * @param key   : Attribute Key which represents the value
         * @param double : double value
         * @return      : true(value exist), false(value not exist)
	...
	//-----------------------------------------------------------------------------
        /**
         * @brief API for getting byte type value with a key
         * @param rep   : Instance of representation
         * @param key   : Attribute Key which represents the value
         * @param value : Byte value
         * @param size  : Size of Byte value
	...
	//-----------------------------------------------------------------------------
        /**
         * @brief API for getting object type value with a key
         * @param mother   : Instance of representation
         * @param key   : Attribute Key which represents the value
         * @param child : object value
         * @return      : true(value exist), false(value not exist)
...
typedef struct things_resource_s {
	...
	//--------------------------------------------------------------------------------
	/**
	 * @brief API for setting device address.
	 * @param things_resource_s * : Instance of target resource
	 * @param OCDevAddr : OC device address
	 */
	...
	*/
	...
	//--------------------------------------------------------------------------------
        /**
        * @brief API for getting # of supporting interface types
        * @param things_resource_s * : Instance of target resource
        * @return              : Number of supporting interface types
        */
	...
	* @param things_resource_s * : Instance of target resource
	* @param index : Index of supported resource type list
	...
	*/
	...
	//--------------------------------------------------------------------------------
        /**
        * @brief API for getting # of supporting interface type with index
        * @param things_resource_s * : Instance of target resource
        * @param index : Index of supported resource type list
        * @return              : Supporting interface type
        */
