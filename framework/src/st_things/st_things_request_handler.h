 ...
 *			  not exist).
 */
bool handle_get_req_helper(const char *ris_uri, const char *query, OCRepPayload *resp_payload);
 ...
 */
bool handle_post_req_helper(const char *ris_uri, const char *query, OCRepPayload *req_payload, OCRepPayload *resp_payload);
